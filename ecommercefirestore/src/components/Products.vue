        ...
        <b-container fluid class="bv-example-row mt-4">        
            <b-row>
                <b-col cols="3" v-for="(fruit, index) in fruits" :key="index" >
                    <b-card
                        :title=fruit.name
                        :img-src="require(`@/assets/fruits/fruit${index + 1}.jpg`)"
                        img-alt="image"
                        img-top
                        tag="article"
                        class="mb-4"
