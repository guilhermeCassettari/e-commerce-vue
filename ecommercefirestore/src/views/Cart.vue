    ...
    <div>
        ...
        <b-container fluid class="mt-4">
                ...
                <b-col class="text-center">
                    <b-table bordered hover :items="cart" :fields="fields">
                        ...
                        <template v-slot:cell(quantity)="data">
                            <b-row>
                                ...
                                <b-col cols="3" class="text-center">
                                    <b-button :disabled="data.item.quantity <= 1" cariant="primary"
                        ...
                        <template v-slot:cell(image)="data">
                            <b-col class="text-center">
                                <b-img style="max-width: 5rem;" :src="require(`@/assets/fruits/fruit${data.item.id}.jpg`)" fluid alt="Responsive Image"></b-img>
                            </b-col>
                        </template>
                    </b-table>
                </b-col>
            ...
            <b-row class="mt-4 text-center" v-if="cart.length > 0">
                ...
                <b-col></b-col>
                <b-col>
                    <b-col cols="4">Whatafuck companheiro ?</b-col>
                </b-col>
                <b-col></b-col>
                <b-col>
            ...
            <b-modal hide-header-close no-close-con-esc no-close-on-backdrop ref="modal-1"
